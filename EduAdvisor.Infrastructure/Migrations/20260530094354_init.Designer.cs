...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduAdvisor.Domain.Entities.Subjects.Subject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EduAdvisor.Domain.Entities.Subjects.SubjectOffering", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SubjectId", "SemesterId", "DepartmentId")
                        .IsUnique();

                    b.ToTable("SubjectOfferings", (string)null);
                });

            modelBuilder.Entity("EduAdvisor.Domain.Entities.Subjects.SubjectPrerequisite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EduAdvisor.Domain.Entities.Enrollments.Enrollment", b =>
                {
                    ...
                    b.HasOne("EduAdvisor.Domain.Entities.Subjects.Subject", "Subject")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("EduAdvisor.Domain.Entities.Subjects.SubjectPrerequisite", b =>
                {
                    ...
                    b.HasOne("EduAdvisor.Domain.Entities.Subjects.Subject", "PrerequisiteSubject")
